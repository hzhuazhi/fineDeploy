    ...
    <div class="formContentDiv">
        <form id="addSupplierForm">
            <ul>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require">团队长名称</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="teamName" name="teamName"	maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="did" name="did"	maxlength="240" />
                    </div>
                </li>
