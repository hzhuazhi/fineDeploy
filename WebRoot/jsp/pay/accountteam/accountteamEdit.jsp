        ...
        <div class="formContentDiv">
            <form id="addSupplierForm">
                <ul>
                    ...
                    <li style="border-top: none;">
                        ...
                        <div class="formCtrlDiv">
                            <select id="type" name="roleId">
                                <option value="">团队长</option>
                            </select>
                        </div>
                    </li>
                    <li style="border-top: none;">
                        <div class="formTextDiv">
                            <span class="require"><font color="red">*</font>团队长名称</span>
                        </div>
                        <div class="formCtrlDiv">
                            <input type="text" class="formInput" id="teamName" name="teamName" value="${dl.teamName}" 	maxlength="240" />
                        </div>
                    </li>
                    <li style="border-top: none;">
                        <div class="formTextDiv">
                    ...
                    <li style="border-top: none;">
                        <div class="formTextDiv">
                            <span class="require">美好账号ID</span>
                        </div>
                        <div class="formCtrlDiv">
                            <input type="text" class="formInput" id="did" name="did" value="${dl.did}" 	maxlength="500" />
                        </div>
                    </li>
                    <li>
                        <div class="" style="margin-bottom: 20px; margin-top: 20px;margin-left:200px;">
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("修改成功！");
                            window.location.href = ctx + "/accountteam/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
