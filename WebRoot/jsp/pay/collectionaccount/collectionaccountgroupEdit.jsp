                ...
                <ul>
                    ...
                    <li style="border-top: none;">
                        <div class="formTextDiv">
                            <span class="require" ><font color="red">*</font>微信号</span>
                        </div>

                        <div class="formCtrlDiv">
                            <input type="text" class="formInput" id="acName" name="acName"	maxlength="240" value="${dl.userId}"  disabled/>
                        </div>
                    </li>
                    ...
                    <li style="border-top: none;">
                        <div class="formTextDiv">
                            <span class="require" ><font color="red">*</font>群名称</span>
                        </div>
                    ...
                    <li style="border-top: none;">
                        <div class="formTextDiv">
                            <span class="require" ><font color="red">*</font>转码后群二维码</span>
                        </div>
                    ...
                    <li style="border-top: none;">
                        ...
                        <div class="formCtrlDiv">
                            <select id="checkStatus" name="checkStatus" class='text-input medium-input'>
                                <c:if test="${dl.checkStatus == 1||dl.checkStatus == -1}">
                    ...
                    <li>
                        <div class="" style="margin-bottom: 20px; margin-top: 20px;margin-left:200px;">
                            <%--<input type="button" class="formBtn" value="启动检测" id="add_xw" name="add_xw" style="background-color: #54D8FE;"/>--%>
...
<%--<li style="border-top: none;">--%>
    ...
    <%--<div >--%>
        ...
        <%--&lt;%&ndash;<input type="text" class="formInput" id="wxQrCodeAds" name="wxQrCodeAds"	value="${dl.wxQrCodeAds}" maxlength="240"  />&ndash;%&gt;--%>
    <%--</div>--%>
</form>
...
<script type="text/javascript">
    ...
    $(function(){
        var    qrcodeIntn =document.getElementById("qrData");
