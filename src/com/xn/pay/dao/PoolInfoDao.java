...
/**
 * @Description 池子的信息的Dao层
 * @Author yoko
 * @Date 2020/8/25 17:13
 * @Version 1.0
 */
public interface PoolInfoDao<T> extends BaseDao<T> {

    /**
     * @Description: 分页-查询等待池的数据总数
     * @param model
     * @return
     * @author yoko
     * @date 2020/8/25 20:50
    */
    public int queryByWaitCount(PoolInfoModel model);
    ...
    */
    ...
    /**
     * @Description: 分页-查询抢单池的数据总数
     * @param model
     * @return
     * @author yoko
     * @date 2020/8/25 20:50
     */
    public int queryByOpenCount(PoolInfoModel model);
