package com.xn.pay.controller.bankcard;
...
public class BankCardController extends BaseController {
    ...
    @Autowired
    private BankService<Bank> bankService;
    ...
    @RequestMapping("/list")
    public String list() {
        return "pay/bankcard/bankcardIndex";
    }
...
//     */
    ...
    public void dataList(HttpServletRequest request, HttpServletResponse response, Bank model) throws Exception {
...
//                model.setId(account.getId());
    ...
    public void dataAllList(HttpServletRequest request, HttpServletResponse response, Bank model) throws Exception {
        List<Bank> dataList = new ArrayList<Bank>();
        Account account = (Account) WebUtils.getSessionAttribute(request, ManagerConstant.PUBLIC_CONSTANT.ACCOUNT);
        if(account !=null && account.getId() > ManagerConstant.PUBLIC_CONSTANT.SIZE_VALUE_ZERO){
            if (account.getRoleId() != ManagerConstant.PUBLIC_CONSTANT.SIZE_VALUE_ONE){
    ...
    public String jumpAdd(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "pay/bankcard/bankcardAdd";
    }
     ...
     */
    @RequestMapping("/add")
    public void add(HttpServletRequest request, HttpServletResponse response, Bank bean) throws Exception {
        Account account = (Account) WebUtils.getSessionAttribute(request, ManagerConstant.PUBLIC_CONSTANT.ACCOUNT);
        if(account !=null && account.getId() > ManagerConstant.PUBLIC_CONSTANT.SIZE_VALUE_ZERO){
    ...
    public String jumpUpdate(Model model, long id, Integer op) {
        Bank bank = new Bank();
        bank.setId(id);
        model.addAttribute("account", bankService.queryById(bank));
        model.addAttribute("bank", mobileCardService.queryAllList());
//        model.addAttribute("account", mobileCardService.queryById(atModel));
//        model.addAttribute("op", op);
        return "pay/bankcard/bankcardEdit";
    }
    ...
    public void update(HttpServletRequest request, HttpServletResponse response,Bank bean, String op) throws Exception {
        Account account = (Account) WebUtils.getSessionAttribute(request, ManagerConstant.PUBLIC_CONSTANT.ACCOUNT);
        if(account !=null && account.getId() > ManagerConstant.PUBLIC_CONSTANT.SIZE_VALUE_ZERO){
    ...
    public void manyOperation(HttpServletRequest request, HttpServletResponse response, Bank bean) throws Exception {
        Account account = (Account) WebUtils.getSessionAttribute(request, ManagerConstant.PUBLIC_CONSTANT.ACCOUNT);
        if(account !=null && account.getId() > ManagerConstant.PUBLIC_CONSTANT.SIZE_VALUE_ZERO){
